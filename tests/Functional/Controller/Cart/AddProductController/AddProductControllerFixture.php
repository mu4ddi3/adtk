...
class AddProductControllerFixture extends AbstractFixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $fullCart->addProduct(new CartProduct($fullCart, $products[0]));
        $fullCart->addProduct(new CartProduct($fullCart, $products[1]));
        $fullCart->addProduct(new CartProduct($fullCart, $products[2]));
